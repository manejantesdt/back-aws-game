...
En el despliegue de este proyecto empleamos la plantilla aws-nodejs para hacer una HTTP API con Node.js corriendo en AWS Lambda y API Gateway, utilizando Serverless Framework.
